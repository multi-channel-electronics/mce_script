...
pro save_exp_params,m,filename
    ...
    spawn,'mas_param -s '+filename+' set config_flux_jump '+str_flat(m.config_flux_jump)
    ...
    spawn,'mas_param -s '+filename+' set frametest_row '+str_flat(m.frametest_row)
    ...
    spawn,'mas_param -s '+filename+' set plot_use_config '+str_flat(m.plot_use_config)
    spawn,'mas_param -s '+filename+' set plot_sq1ramp_rows '+str_flat(m.plot_sq1ramp_rows)
end
...
pro load_exp_params,filename,m
    m = create_struct('_source',filename,  $
        ...
        'config_flux_jump',mas_param_int(filename,'config_flux_jump'),  $
        ...
        'frametest_row',mas_param_int(filename,'frametest_row'),  $
        ...
        'plot_use_config',mas_param_int(filename,'plot_use_config'),  $
        'plot_sq1ramp_rows',mas_param_int(filename,'plot_sq1ramp_rows')    )
end
