...
int_keys = ['array_width', 'hardware_rc', 'hardware_sync',
    ...
    'ramp_tes_period_us', 'iv_data_mode', 'bias_line_card', 'bias_line_para',
    'config_rc', 'config_sync', 'config_fast_sq2', 'config_dead_tes',
    'data_rate', 'row_len', 'num_rows', 'num_rows_reported',
    'readout_row_index', 'sample_dly', 'sample_num', 'fb_dly', 'row_dly',
    'data_mode', 'flux_jumping', 'servo_mode', 'servo_p', 'servo_i',
    'servo_d', 'dead_detectors', 'tes_bias', 'row_order',
    'config_flux_quanta_all', 'flux_quanta', 'flux_quanta_all', 'fb_const',
    'sq1_bias', 'sq1_bias_off', 'sq2_bias', 'sq2_fb', 'sq2_fb_set', 'sa_bias',
    'sa_fb', 'sa_offset', 'config_adc_offset_all', 'adc_offset_c',
    'adc_offset_cr'] 
